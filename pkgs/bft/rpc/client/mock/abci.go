...
func (a ABCIApp) ABCIInfo() (*ctypes.ResultABCIInfo, error) {
	return &ctypes.ResultABCIInfo{Response: a.App.Info(abci.RequestInfo{})}, nil
}

func (a ABCIApp) ABCIQuery(path string, data []byte) (*ctypes.ResultABCIQuery, error) {
...
func (a ABCIApp) BroadcastTxAsync(tx types.Tx) (*ctypes.ResultBroadcastTx, error) {
	...
	return &ctypes.ResultBroadcastTx{Error: c.Error, Data: c.Data, Log: c.Log, Hash: tx.Hash()}, nil
}
...
func (m ABCIMock) ABCIQuery(path string, data []byte) (*ctypes.ResultABCIQuery, error) {
...
func (r *ABCIRecorder) ABCIQuery(path string, data []byte) (*ctypes.ResultABCIQuery, error) {
